...
History: PJN / 13-07-2019 1. Initial implementation
         ...
         PJN / 20-08-2021 1. Fixed a bug in CAARiseTransitSet2::CalculateMoon in the calculation of the H0
                          ...
                          H0 value for the Moon is notant and is calculated from this value in this method
...
void CAARiseTransitSet2::AddEvents(System::Collections::Generic::List<CAARiseTransitSetDetails2>^% events, double LastAltitudeForDetectingRiseSet, double AltitudeForDetectingRiseSet,
...
System::Collections::Generic::List<CAARiseTransitSetDetails2>^ CAARiseTransitSet2::Calculate(double StartJD, double EndJD, Object object, double Longitude, double Latitude, double h0, double StepInterval, bool bHighPrecision)
{
  //What will be the return value
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events = gcnew System::Collections::Generic::List<CAARiseTransitSetDetails2>(0);
  ...
  while (JD < EndJD)
  {
    ...
    switch (object)
    {
      case Object::SUN:
      {
        double Long{CAASun::ApparentEclipticLongitude(JD, bHighPrecision)};
        double Lat{CAASun::ApparentEclipticLatitude(JD, bHighPrecision)};
        CAA2DCoordinate Equatorial{CAACoordinateTransformation::Ecliptic2Equatorial(Long, Lat, CAANutation::TrueObliquityOfEcliptic(JD))};
        double SunRad{CAAEarth::RadiusVector(JD, bHighPrecision)};
        Topo = CAAParallax::Equatorial2Topocentric(Equatorial.X, Equatorial.Y, SunRad, Longitude, Latitude, 0, JD);
        break;
      }
      case Object::MOON:
      {
        double Long{CAAMoon::EclipticLongitude(JD)};
        double Lat{CAAMoon::EclipticLatitude(JD)};
        CAA2DCoordinate Equatorial{CAACoordinateTransformation::Ecliptic2Equatorial(Long, Lat, CAANutation::TrueObliquityOfEcliptic(JD))};
        double MoonRad{CAAMoon::RadiusVector(JD)/149597871}; //Convert Kms to AUs
    ...
    CAA2DCoordinate Horizontal{CAACoordinateTransformation::Equatorial2Horizontal(LocalHourAngle, Topo.Y, Latitude)};
...
//The higher accuracy version for the moon where the "standard altitude" is not treated as aant
System::Collections::Generic::List<CAARiseTransitSetDetails2>^ CAARiseTransitSet2::CalculateMoon(double StartJD, double EndJD, double Longitude, double Latitude, double RefractionAtHorizon, double StepInterval, MoonAlgorithm algorithm)
{
  //What will be the return value
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events = gcnew System::Collections::Generic::List<CAARiseTransitSetDetails2>(0);
  ...
  while (JD < EndJD)
  {
    ...
    CAA2DCoordinate Equatorial{CAACoordinateTransformation::Ecliptic2Equatorial(MoonPos.X, MoonPos.Y, CAANutation::TrueObliquityOfEcliptic(JD))};
    CAA2DCoordinate Topo{CAAParallax::Equatorial2Topocentric(Equatorial.X, Equatorial.Y, MoonRad/149597871, Longitude, Latitude, 0, JD)};
    double AST{CAASidereal::ApparentGreenwichSiderealTime(JD)};
    double LocalHourAngle{AST - LongtitudeAsHourAngle - Topo.X};
    CAA2DCoordinate Horizontal{CAACoordinateTransformation::Equatorial2Horizontal(LocalHourAngle, Topo.Y, Latitude)};
    double h0{RefractionAtHorizon - CAACoordinateTransformation::RadiansToDegrees(asin(1737.4/MoonRad))};
    double AltitudeForDetectingRiseSet{Horizontal.Y - h0};
...
System::Collections::Generic::List<CAARiseTransitSetDetails2>^ CAARiseTransitSet2::CalculateStationary(double StartJD, double EndJD, double Alpha, double Delta, double Longitude, double Latitude, double h0, double StepInterval)
{
  //What will be the return value
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events = gcnew System::Collections::Generic::List<CAARiseTransitSetDetails2>(0);
  ...
  while (JD < EndJD)
  {
    ...
    CAA2DCoordinate Horizontal{CAACoordinateTransformation::Equatorial2Horizontal(LocalHourAngle, Delta, Latitude)};
    double AltitudeForDetectingRiseSet{Horizontal.Y - h0};
