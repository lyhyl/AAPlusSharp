...
History: PJN / 04-07-2010 Removed unnecessary "Longitude" parameter from method Ecliptic2Topocentric.
         ...
         PJN / 12-07-2023 1. Updated AAParallax.cpp to use a more accurate value of the Solar Parallaxant of 
...
double g_AAParallax_C1 = 4.2635232628103847e-05; //sin(CAACoordinateTransformation::DegreesToRadians(CAACoordinateTransformation::DMSToDegrees(0, 0, 8.794148)));
