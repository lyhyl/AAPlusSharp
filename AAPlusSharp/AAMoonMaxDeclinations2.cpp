...
System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>^ CAAMoonMaxDeclinations2::Calculate(double StartJD, double EndJD, double StepInterval, Algorithm algorithm)
{
  //What will be the return value
  System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>^ events = gcnew System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>(0);
