...
std::array<PlutoCoefficient1, 43> g_PlutoArgumentCoefficients
{ {
  { 0,   0,    1 },
  { 0,   0,    2 },
  { 0,   0,    3 },
...
std::array<PlutoCoefficient2, 43> g_PlutoLongitudeCoefficients
{ {
  { -19799805, 19850055 },
  {  897144,  -4954829  },
  {  611149,   1211027  },
...
std::array<PlutoCoefficient2, 43> g_PlutoLatitudeCoefficients
{ {
  { -5452852, -14974862 },
  {  3527812,  1672790  },
  { -1050748,  327647   },
...
std::array<PlutoCoefficient2, 43> g_PlutoRadiusCoefficients
{ {
  {  66865439,   68951812 },
  { -11827535,  -332538   },
  {  1593179,   -1438890  },
...
double CAAPluto::EclipticLongitude(double JD)
{
  ...
  //Calculate Longitude
  double L{0};
  size_t nPlutoCoefficients{g_PlutoArgumentCoefficients.size()};
