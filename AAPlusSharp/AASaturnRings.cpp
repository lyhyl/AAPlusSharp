...
CAASaturnRingDetails CAASaturnRings::Calculate(double JD, bool bHighPrecision)
{
  ...
  double sinlambdaminusomegarad{sin(lambda - omegarad)};
  ...
  double sinbdashrad{sin(bdashrad)};
  double cosbdashrad{cos(bdashrad)};
  double sinldashradminusomegarad{sin(ldashrad - omegarad)};
  ...
  double cosdelta0{cos(delta0)};
  double alpha0minusalpha{alpha0 - alpha};
