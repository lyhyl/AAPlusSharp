...
System::Collections::Generic::List<CAAPlanetPerihelionAphelionDetails2>^ CAAPlanetPerihelionAphelion2::Calculate(double StartJD, double EndJD, Object object, double StepInterval, bool bHighPrecision)
{
  //What will be the return value
  System::Collections::Generic::List<CAAPlanetPerihelionAphelionDetails2>^ events = gcnew System::Collections::Generic::List<CAAPlanetPerihelionAphelionDetails2>(0);
