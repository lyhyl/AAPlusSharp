...
void GetSolarRaDecByJulian2(double JD, bool bHighPrecision, double% RA, double% Dec)
{
  double lambda{CAASun::GeometricFK5EclipticLongitude(JD, bHighPrecision)};
  double beta{CAASun::GeometricFK5EclipticLatitude(JD, bHighPrecision)};
...
void ASCIIPlot(System::Collections::Generic::List<char>^% buf, int buf_w, int x, int y, bool b)
{
  size_t nIndex{static_cast<size_t>(x) + (static_cast<size_t>(y)*buf_w)};
#ifdef _MSC_VER
...
void DrawFilledEllipse(System::Collections::Generic::List<char>^% buf, int buf_w, int c_x, int c_y, int w, int h, bool half_l, bool half_r, bool b)
{
  int hh{h*h};
  int ww{w*w};
  int hhww{hh*ww};
...
void PrintMoonPhase(double position_angle, double phase_angle)
{
  ...
  int buf_w{80};
  int buf_h{40};
  System::Collections::Generic::List<char>^ buf = gcnew System::Collections::Generic::List<char>(0);
...
{
  CAADate CalcDate{year, month, static_cast<double>(day), true};
...
void PrintBostonRiseTransitSetTimes(CAARiseTransitSet2::Object object, double h0, char* objectName)
{
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::Calculate(CAADynamicalTime::UTC2TT(2447240.5), CAADynamicalTime::UTC2TT(2447241.5), object, 71.0833, 42.3333, h0)};
  for (auto& event : events)
  {
    switch (event.type)
    {
      ...
      {
        CAADate date_time{CAADynamicalTime::TT2UTC(event.JD), true};
        long year{0};
        long month{0};
        long day{0};
        long hour{0};
...
{
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::Calculate(CAADynamicalTime::UTC2TT(2459436.5), CAADynamicalTime::UTC2TT(2459437.499988426), CAARiseTransitSet2::Object::SUN, 75.466003, 39.129501, -0.8333)};
  for (auto& event : events)
  {
    switch (event.type)
    {
      case CAARiseTransitSetDetails2::Type::Rise:
      {
        CAADate date_time{event.JD, true};
        long year{0};
        long month{0};
        long day{0};
        long hour{0};
...
{
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::CalculateMoon(CAADynamicalTime::UTC2TT(2447240.5), CAADynamicalTime::UTC2TT(2447241.5), 71.0833, 42.3333)};
  for (auto& event : events)
  {
    switch (event.type)
    {
...
{
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::Calculate(CAADynamicalTime::UTC2TT(2459427.5), CAADynamicalTime::UTC2TT(2459432.5), CAARiseTransitSet2::Object::MOON, -4.3407, 50.8024, -0.825)};
  for (auto& event : events)
  {
    switch (event.type)
    {
...
{
  std::pair<CAARiseTransitSet2::MoonAlgorithm, char*> algos[] //NOLINT(modernize-avoid-c-arrays)
  {
  ...
  for (auto& algo : algos)
  {
    System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::CalculateMoon(CAADynamicalTime::UTC2TT(2459427.5), CAADynamicalTime::UTC2TT(2459432.5), -4.3407, 50.8024, -0.5667, 0.007, algo.first)};
    for (auto& event : events)
    {
      switch (event.type)
      {
...
{
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::CalculateStationary(CAADynamicalTime::UTC2TT(2447240.5), CAADynamicalTime::UTC2TT(2447241.5), CAACoordinateTransformation::DMSToDegrees(06, 44, 38.11), CAACoordinateTransformation::DMSToDegrees(16, 42, 01.5, false), 71.0833, 42.3333)};
  for (auto& event : events)
  {
    switch (event.type)
    {
...
int main()
{
  ...
  auto e1{CAAEaster::Calculate(2021, true)};
  ...
  double venML{CAAElementsPlanetaryOrbit::VenusMeanLongitudeJ2000(2411545.0)};
  UNREFERENCED_PARAMETER(venML);
  double venI{CAAElementsPlanetaryOrbit::VenusInclinationJ2000(2411545.0)};
  UNREFERENCED_PARAMETER(venI);
  double venW{CAAElementsPlanetaryOrbit::VenusLongitudePerihelionJ2000(2411545.0)};
  UNREFERENCED_PARAMETER(venW);
  double venOmega{CAAElementsPlanetaryOrbit::VenusLongitudeAscendingNodeJ2000(2411545.0)};
  ...
  auto venDetails{CAAElliptical::Calculate(2411545.0, venElements, false)};
  UNREFERENCED_PARAMETER(venDetails);
  auto venDetails2{CAAElliptical::Calculate(2411545.0, venElements, true)};
  ...
  auto pluDetails{CAAElliptical::Calculate(2411545.0, pluElements, false)};
  UNREFERENCED_PARAMETER(pluDetails);
  auto pluDetails2{CAAElliptical::Calculate(2411545.0, pluElements, false)};
  ...
  auto embDetails{CAAElliptical::Calculate(2411545.0, embElements, false)};
  UNREFERENCED_PARAMETER(embDetails);
  auto embDetails2{CAAElliptical::Calculate(2411545.0, embElements, false)};
  ...
  */
  ...
  {
    double NewMoon{CAAMoonPhases::TruePhase(k)};
    ...
    double FirstQuarter{CAAMoonPhases::TruePhase(k + 0.25)};
  ...
  std::pair<CAAMoonPhases2::Algorithm, char*> algos4[] //NOLINT(modernize-avoid-c-arrays)
  {
  ...
  for (auto& algo : algos4)
  {
    System::Collections::Generic::List<CAAMoonPhasesDetails2>^ events4{CAAMoonPhases2::Calculate(CAADynamicalTime::UTC2TT(2458484.5), CAADynamicalTime::UTC2TT(2458848.5), 0.007, algo.first)};
    for (auto& event : events4)
    {
      switch (event.type)
      {
  ...
  {
    double MoonNode1{CAAMoonNodes::PassageThroNode(k)};
    ...
    double MoonNode2{CAAMoonNodes::PassageThroNode(k + 0.5)};
  ...
  std::pair<CAAMoonNodes2::Algorithm, char*> algos3[] //NOLINT(modernize-avoid-c-arrays)
  {
  ...
  for (auto& algo : algos3)
  {
    System::Collections::Generic::List<CAAMoonNodesDetails2>^ events4{CAAMoonNodes2::Calculate(CAADynamicalTime::UTC2TT(2458484.5), CAADynamicalTime::UTC2TT(2458848.5), 0.007, algo.first)};
    for (auto& event : events4)
    {
      switch (event.type)
      {
  ...
  for (int k{252}; k<266; k++)
  {
    ...
    double MoonPerigeeValue{CAAMoon::HorizontalParallaxToRadiusVector(CAAMoonPerigeeApogee::PerigeeParallax(k))};
    ...
    double MoonApogee{CAAMoonPerigeeApogee::TrueApogee(k + 0.5)};
    double MoonApogeeValue{CAAMoon::HorizontalParallaxToRadiusVector(CAAMoonPerigeeApogee::ApogeeParallax(k))}; //NOLINT(clang-analyzer-deadcode.DeadStores, clang-diagnostic-unused-variable)
  ...
  std::pair<CAAMoonPerigeeApogee2::Algorithm, char*> algos2[] //NOLINT(modernize-avoid-c-arrays)
  {
  ...
  {
    System::Collections::Generic::List<CAAMoonPerigeeApogeeDetails2>^ events3{CAAMoonPerigeeApogee2::Calculate(CAADynamicalTime::UTC2TT(2458484.5), CAADynamicalTime::UTC2TT(2458848.5), 0.007, algo.first)};
    for (auto& event : events3)
    {
      switch (event.type)
      {
  ...
  System::Collections::Generic::List<CAARiseTransitSetDetails2>^ events{CAARiseTransitSet2::Calculate(CAADynamicalTime::UTC2TT(2458484.5), CAADynamicalTime::UTC2TT(2458484.5 + 365), CAARiseTransitSet2::Object::SUN, 0, 90, -0.8333)};
  for (auto& event : events)
  {
    switch (event.type)
    {
  ...
  System::Collections::Generic::List<CAAEquinoxSolsticeDetails2>^ events2{CAAEquinoxesAndSolstices2::Calculate(CAADynamicalTime::UTC2TT(2458484.5), CAADynamicalTime::UTC2TT(2458848.5))};
  ...
  std::pair<CAAMoonMaxDeclinations2::Algorithm, char*> algos[] //NOLINT(modernize-avoid-c-arrays)
  {
  ...
  for (auto& algo : algos)
  {
    System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>^ events3{CAAMoonMaxDeclinations2::Calculate(CAADynamicalTime::UTC2TT(2458484.5), CAADynamicalTime::UTC2TT(2458848.5), 0.007, algo.first)};
    for (auto& event : events3)
    {
      switch (event.type)
      {
  ...
  double n{CAAVSOP2013::CalculateMeanMotion(CAAVSOP2013::Planet::EARTH_MOON_BARYCENTER, 1)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  ...
  try
  {
    auto pluto{vsop.Calculate(CAAVSOP2013::Planet::PLUTO, 77432.5)}; //NOLINT(clang-analyzer-deadcode.DeadStores, clang-diagnostic-unused-variable)
  ...
  try
  {
    auto pluto{vsop.Calculate(CAAVSOP2013::Planet::PLUTO, 487826.5)}; //NOLINT(clang-analyzer-deadcode.DeadStores, clang-diagnostic-unused-variable)
    UNREFERENCED_PARAMETER(pluto);
  }
  catch (CAAVSOP2013Exception&)
  {
  ...
  while (bContinueLoop)
  {
    if ((static_cast<int>(JD3) % 200000) == 0)
      ::printf("*");
    auto pos{vsop.Calculate(CAAVSOP2013::Planet::PLUTO, JD3)}; //NOLINT(clang-analyzer-deadcode.DeadStores, clang-diagnostic-unused-variable)
    JD3 += 0.47;
    bContinueLoop = (JD3 < 2816814.5);
  }

  auto merOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::MERCURY, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(merOrbit);
  auto merElements{vsop.OrbitToElements(2411545.0, CAAVSOP2013::Planet::MERCURY, merOrbit)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  ...
  auto merEqu{vsop.Ecliptic2Equatorial(mer)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  ...
  double JD1{2411545.0};
  double T{(JD1 - 2451545)/365250};
  double lambdas1{3.176134461576 + (10213.28554743445*T)}; //Venus
  lambdas1 = CAACoordinateTransformation::MapTo0To2PIRange(lambdas1);
  double ML{CAACoordinateTransformation::RadiansToDegrees(lambdas1)};
  UNREFERENCED_PARAMETER(ML);
  auto venOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::VENUS, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  auto venVSOPElements{vsop.OrbitToElements(2411545.0, CAAVSOP2013::Planet::VENUS, venOrbit)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  ...
  auto venEqu{vsop.Ecliptic2Equatorial(ven)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(venEqu);

  auto pluOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::PLUTO, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  auto pluVSOPElements{vsop.OrbitToElements(2411545.0, CAAVSOP2013::Planet::PLUTO, pluOrbit)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(pluVSOPElements);
  auto plu{vsop.Calculate(CAAVSOP2013::Planet::PLUTO, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(plu);

  auto earOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::EARTH_MOON_BARYCENTER, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  auto earElements{vsop.OrbitToElements(2411545.0, CAAVSOP2013::Planet::EARTH_MOON_BARYCENTER, earOrbit)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(earElements);
  auto ear{vsop.Calculate(CAAVSOP2013::Planet::EARTH_MOON_BARYCENTER, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(ear);

  auto marsOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::MARS, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(marsOrbit);
  auto jupiterOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::JUPITER, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(jupiterOrbit);
  auto saturnOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::SATURN, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(saturnOrbit);
  auto uranusOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::URANUS, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(uranusOrbit);
  auto neptuneOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::NEPTUNE, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  UNREFERENCED_PARAMETER(neptuneOrbit);
  auto plutoOrbit{vsop.CalculateOrbit(CAAVSOP2013::Planet::PLUTO, 2411545.0)}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  ...
  */
  ...
  /*
  {
    ...
    while (bContinue)
    {
      CAAEllipticalPlanetaryDetails VenusDetails{CAAElliptical::Calculate(JD, CAAElliptical::Object::VENUS, false)};
      CAAEllipticalPlanetaryDetails MercuryDetails{CAAElliptical::Calculate(JD, CAAElliptical::Object::MERCURY, false)};
      double AngularSeparation{CAAAngularSeparation::Separation(VenusDetails.ApparentGeocentricRA, VenusDetails.ApparentGeocentricDeclination, MercuryDetails.ApparentGeocentricRA, MercuryDetails.ApparentGeocentricDeclination)};
  ...
  */
  ...
  //Code to write out the values of TT-UTC for a specific range
  {
    ...
    while (bContinue2)
    {
      ...
      CAADate date{JDUT1, CAADate::AfterPapalReform(JDUT1)};
      long year{0};
      long month{0};
      long Day{0};
      long Hour{0};
  ...
  */
  ...
  //Code to write out the values of DeltaT for a specific range
  {
    ...
    while (bContinue3)
    {
      ...
      CAADate date{JDD, CAADate::AfterPapalReform(JDD))};
      long year{0};
      long month{0};
      long Day{0};
      long Hour{0};
  ...
  */
  ...
  for (int YYYY{-4712}; YYYY<5000; YYYY++) //Change the end YYYY value if you would like to test a longer range
  {
    ...
    for (int MMMM{1}; MMMM<=12; MMMM++)
    {
      ...
      for (int DDDD{1}; DDDD<=CAADate::DaysInMonth(MMMM, bLeap); DDDD++)
      {
        ...
        CAADate date{YYYY, MMMM, static_cast<double>(DDDD), 12, 0, 0, bGregorian};
  ...
  double alpha2{CAACoordinateTransformation::MapTo0To24Range(AST - Equatorial3.X - LongitudeAsHourAngle)};
  ...
  double Obliquity2{CAANutation::TrueObliquityOfEcliptic(date.Julian())};
  ...
  CAA2DCoordinate PA4{CAAPrecession::AdjustPositionUsingMotionInSpace(2.64, -7.6, -2000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA4);
  CAA2DCoordinate PA5{CAAPrecession::AdjustPositionUsingMotionInSpace(2.64, -7.6, -3000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA5);
  CAA2DCoordinate PA6{CAAPrecession::AdjustPositionUsingMotionInSpace(2.64, -7.6, -4000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA6);
  CAA2DCoordinate PA7{CAAPrecession::AdjustPositionUsingMotionInSpace(2.64, -7.6, -12000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA7);
  CAA2DCoordinate PA8{CAAPrecession::AdjustPositionUsingUniformProperMotion(-1000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA8);
  CAA2DCoordinate PA9{CAAPrecession::AdjustPositionUsingUniformProperMotion(-2000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA9);
  CAA2DCoordinate PA10{CAAPrecession::AdjustPositionUsingUniformProperMotion(-3000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA10);
  CAA2DCoordinate PA11{CAAPrecession::AdjustPositionUsingUniformProperMotion(-4000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  UNREFERENCED_PARAMETER(PA11);
  CAA2DCoordinate PA12{CAAPrecession::AdjustPositionUsingUniformProperMotion(-12000, CAACoordinateTransformation::DMSToDegrees(6, 45, 8.871), CAACoordinateTransformation::DMSToDegrees(16, 42, 57.99, false), -0.03847, -1.2053)};
  ...
  CAA2DCoordinate Aberration{CAAAberration::EquatorialAberration(PA13.X, PA13.Y, 2462088.69, false)};
  PA13.X += Aberration.X;
  PA13.Y += Aberration.Y;
  CAA2DCoordinate Aberration2{CAAAberration::EquatorialAberration(PA13.X, PA13.Y, 2462088.69, true)};
  ...
  double AlphaNutation{CAANutation::NutationInRightAscension(PA13.X, PA13.Y, Obliquity, NutationInLongitude, NutationInEcliptic)};
  double DeltaNutation{CAANutation::NutationInDeclination(PA13.X, Obliquity, NutationInLongitude, NutationInEcliptic)};
  ...
  System::Collections::Generic::List<double>^ Mags{ 4.73, 5.22, 5.60 };
  double CombinedMag2{CAAStellarMagnitudes::CombinedMagnitude(static_cast<int>(Mags.size()), Mags.data())};
  ...
  double MercuryKp{CAAPlanetPerihelionAphelion::MercuryK(2021)};
  ::printf("Mercury K: %f\n", MercuryKp);
  double MercuryPerihelion{CAAPlanetPerihelionAphelion::Mercury(static_cast<long>(MercuryKp))};
  ...
  double MercuryAphelion{CAAPlanetPerihelionAphelion::Mercury(static_cast<long>(MercuryKp) + 0.5)};
  ...
  double VenusK{CAAPlanetPerihelionAphelion::VenusK(1978.79)};
  ::printf("Venus K: %f\n", VenusK);
  double VenusPerihelion{CAAPlanetPerihelionAphelion::Venus(static_cast<long>(VenusK))};
  ...
  double VenusAphelion{CAAPlanetPerihelionAphelion::Venus(static_cast<long>(VenusK) + 0.5)};
  ...
  double EarthK{CAAPlanetPerihelionAphelion::EarthK(2021)};
  ::printf("Earth K: %f\n", EarthK);
  double EarthPerihelion3{CAAPlanetPerihelionAphelion::EarthPerihelion(static_cast<long>(EarthK), false)};
  date_time = CAADate{CAADynamicalTime::TT2UTC(EarthPerihelion3), true};
  date_time.Get(year, month, day, hour, minute, second);
  ::printf("Perihelion of Earth (using CAAPlanetPerihelionAphelion) (UTC), %d-%d-%d %02d:%02d:%02d\n", static_cast<int>(year), static_cast<int>(month), static_cast<int>(day), static_cast<int>(hour), static_cast<int>(minute), static_cast<int>(second));
  double EarthAphelion1{CAAPlanetPerihelionAphelion::EarthAphelion(static_cast<long>(EarthK) + 0.5, false)};
  ...
  double EarthK2{CAAPlanetPerihelionAphelion::EarthK(2000.5)};
  double EarthAphelion2{CAAPlanetPerihelionAphelion::EarthAphelion(static_cast<long>(EarthK2) + 0.5, false)};
  date_time = CAADate{CAADynamicalTime::TT2UTC(EarthAphelion2), true};
  date_time.Get(year, month, day, hour, minute, second);
  ::printf("Aphelion of Earth (using CAAPlanetPerihelionAphelion) (UTC), %d-%d-%d %02d:%02d:%02d\n", static_cast<int>(year), static_cast<int>(month), static_cast<int>(day), static_cast<int>(hour), static_cast<int>(minute), static_cast<int>(second));
  double MarsK{CAAPlanetPerihelionAphelion::MarsK(2032)};
  ::printf("Mars K: %f\n", MarsK);
  double MarsPerihelion{CAAPlanetPerihelionAphelion::Mars(static_cast<long>(MarsK))};
  ...
  double MarsAphelion{CAAPlanetPerihelionAphelion::Mars(static_cast<long>(MarsK) + 0.5)};
  ...
  double JupiterK{CAAPlanetPerihelionAphelion::JupiterK(2021)};
  ::printf("Jupiter K: %f\n", JupiterK);
  double JupiterPerihelion{CAAPlanetPerihelionAphelion::Jupiter(static_cast<long>(JupiterK))};
  ...
  double JupiterAphelion{CAAPlanetPerihelionAphelion::Jupiter(static_cast<long>(JupiterK) + 0.5)};
  ...
  double SaturnK1{CAAPlanetPerihelionAphelion::SaturnK(1925)};
  ::printf("Saturn K: %f\n", SaturnK1);
  double SaturnK2{CAAPlanetPerihelionAphelion::SaturnK(1940)};
  ::printf("Saturn K: %f\n", SaturnK2);
  double SaturnPerihelion{CAAPlanetPerihelionAphelion::Saturn(static_cast<long>(SaturnK2))};
  ...
  double SaturnAphelion{CAAPlanetPerihelionAphelion::Saturn(static_cast<long>(SaturnK2) + 0.5)};
  ...
  double UranusK1{CAAPlanetPerihelionAphelion::UranusK(1750)};
  ::printf("Uranus K: %f\n", UranusK1);
  double UranusAphelion{CAAPlanetPerihelionAphelion::Uranus(static_cast<long>(UranusK1) + 0.5)};
  ...
  double UranusK2{CAAPlanetPerihelionAphelion::UranusK(1890)};
  ::printf("Uranus K: %f\n", UranusK2);
  double UranusPerihelion{CAAPlanetPerihelionAphelion::Uranus(static_cast<long>(UranusK2))}; //NOLINT(clang-analyzer-deadcode.DeadStores)
  ...
  double UranusK3{CAAPlanetPerihelionAphelion::UranusK(2060)};
  ::printf("Uranus K: %f\n", UranusK3);
  double UranusPerihelion3{CAAPlanetPerihelionAphelion::Uranus(static_cast<long>(UranusK3))};
  date_time = CAADate{CAADynamicalTime::TT2UTC(UranusPerihelion3), true};
  date_time.Get(year, month, day, hour, minute, second);
  ::printf("Perihelion of Uranus (using CAAPlanetPerihelionAphelion) (UTC), %d-%d-%d %02d:%02d:%02d\n", static_cast<int>(year), static_cast<int>(month), static_cast<int>(day), static_cast<int>(hour), static_cast<int>(minute), static_cast<int>(second));
  double NeptuneK{CAAPlanetPerihelionAphelion::NeptuneK(1850)};
  ::printf("Neptune K: %f\n", NeptuneK);
  double NeptunePerihelion{CAAPlanetPerihelionAphelion::Neptune(static_cast<long>(NeptuneK))};
  ...
  double NeptuneAphelion{CAAPlanetPerihelionAphelion::Neptune(static_cast<long>(NeptuneK) + 0.5)};
  ...
  System::Collections::Generic::List<CAAPlanetPerihelionAphelionDetails2>^ events6{CAAPlanetPerihelionAphelion2::Calculate(CAADynamicalTime::UTC2TT(2443509.5), CAADynamicalTime::UTC2TT(2443874.5), CAAPlanetPerihelionAphelion2::Object::VENUS, 0.007, false)};
  for (auto& event : events6)
  {
    switch (event.type)
    {
  ...
  CAAEllipticalPlanetaryDetails VenusDetails{CAAElliptical::Calculate(2448976.5, CAAElliptical::Object::VENUS, false)};
  UNREFERENCED_PARAMETER(VenusDetails);
  CAAEllipticalPlanetaryDetails VenusDetails2{CAAElliptical::Calculate(2448976.5, CAAElliptical::Object::VENUS, true)};
  UNREFERENCED_PARAMETER(VenusDetails2);
  CAAEllipticalPlanetaryDetails VenusDetails3{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::Object::VENUS, false)};
  UNREFERENCED_PARAMETER(VenusDetails3);
  CAAEllipticalPlanetaryDetails VenusDetails4{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::Object::VENUS, true)};
  UNREFERENCED_PARAMETER(VenusDetails4);
  CAAEllipticalPlanetaryDetails VenusDetails5{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457214.6), CAAElliptical::Object::VENUS, false)};
  UNREFERENCED_PARAMETER(VenusDetails5);
  CAAEllipticalPlanetaryDetails VenusDetails6{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457214.6), CAAElliptical::Object::VENUS, true)};
  UNREFERENCED_PARAMETER(VenusDetails6);
  CAAEllipticalPlanetaryDetails SunDetails{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::Object::SUN, false)};
  UNREFERENCED_PARAMETER(SunDetails);
  CAAEllipticalPlanetaryDetails SunDetails2{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2453149.5), CAAElliptical::Object::SUN, true)};
  UNREFERENCED_PARAMETER(SunDetails2);
  CAAEllipticalPlanetaryDetails SunDetails3{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457214.6), CAAElliptical::Object::SUN, false)};
  UNREFERENCED_PARAMETER(SunDetails3);
  CAAEllipticalPlanetaryDetails SunDetails4{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457214.6), CAAElliptical::Object::SUN, true)};
  UNREFERENCED_PARAMETER(SunDetails4);
  CAAEllipticalPlanetaryDetails SunDetails5{CAAElliptical::Calculate(2448908.5, CAAElliptical::Object::SUN, false)};
  UNREFERENCED_PARAMETER(SunDetails5);
  CAAEllipticalPlanetaryDetails SunDetails6{CAAElliptical::Calculate(2448908.5, CAAElliptical::Object::SUN, true)};
  UNREFERENCED_PARAMETER(SunDetails6);
  CAAEllipticalPlanetaryDetails SunDetails7{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457213.875), CAAElliptical::Object::SUN, false)};
  UNREFERENCED_PARAMETER(SunDetails7);
  CAAEllipticalPlanetaryDetails SunDetails8{CAAElliptical::Calculate(CAADynamicalTime::UTC2TT(2457213.875), CAAElliptical::Object::SUN, true)};
  ...
  CAAParabolicObjectDetails details9{CAAParabolic::Calculate(elements7.T + 112.5642, elements7, false)};
  UNREFERENCED_PARAMETER(details9);
  CAAParabolicObjectDetails details10{CAAParabolic::Calculate(elements7.T + 112.5642, elements7, true)};
  ...
  System::Collections::Generic::List<double>^ X1{ 29.43, 30.97, 27.69, 28.11, 31.58, 33.05 };
  System::Collections::Generic::List<double>^ Y1{ 0.4913598528, 0.5145891926, 0.4646875083, 0.4711658342, 0.5236885653, 0.5453707057 };
  assert(X1.size() == Y1.size());
  double Y4{CAAInterpolate::LagrangeInterpolate(30, static_cast<int>(X1.size()), X1.data(), Y1.data())};
  UNREFERENCED_PARAMETER(Y4);
  double Y5{CAAInterpolate::LagrangeInterpolate(0, static_cast<int>(X1.size()), X1.data(), Y1.data())};
  UNREFERENCED_PARAMETER(Y5);
  double Y6{CAAInterpolate::LagrangeInterpolate(90, static_cast<int>(X1.size()), X1.data(), Y1.data())};
  ...
  double Parallax1{CAAMoon::RadiusVectorToHorizontalParallax(384400)};
  UNREFERENCED_PARAMETER(Parallax1);
  double Parallax2{CAAMoon::RadiusVectorToHorizontalParallax(384400 - 6378.14)};
  ...
  Kpp = floor(Kpp + 0.5);
  ::printf("Mercury K: %f\n", Kpp);
  double MercuryInferiorConjunction{CAAPlanetaryPhenomena::Mean(Kpp, CAAPlanetaryPhenomena::Planet::MERCURY, CAAPlanetaryPhenomena::Type::INFERIOR_CONJUNCTION)};
  ::printf("Mercury Mean Inferior Conjunction: %f\n", MercuryInferiorConjunction);
  double MercuryInferiorConjunction2{CAAPlanetaryPhenomena::True(Kpp, CAAPlanetaryPhenomena::Planet::MERCURY, CAAPlanetaryPhenomena::Type::INFERIOR_CONJUNCTION)};
  ...
  Kpp2 = floor(Kpp2 + 0.5);
  ::printf("Saturn K: %f\n", Kpp2);
  double SaturnConjunction{CAAPlanetaryPhenomena::Mean(Kpp2, CAAPlanetaryPhenomena::Planet::SATURN, CAAPlanetaryPhenomena::Type::CONJUNCTION)};
  ::printf("Saturn Mean Conjuction: %f\n", SaturnConjunction);
  double SaturnConjunction2{CAAPlanetaryPhenomena::True(Kpp2, CAAPlanetaryPhenomena::Planet::SATURN, CAAPlanetaryPhenomena::Type::CONJUNCTION)};
  ::printf("Saturn True Conjuction: %f\n", SaturnConjunction2);
  double MercuryWesternElongation{CAAPlanetaryPhenomena::True(Kpp, CAAPlanetaryPhenomena::Planet::MERCURY, CAAPlanetaryPhenomena::Type::WESTERN_ELONGATION)};
  ::printf("Mercury Mean Western Elongation: %f\n", MercuryWesternElongation);
  double MercuryWesternElongationValue{CAAPlanetaryPhenomena::ElongationValue(Kpp, CAAPlanetaryPhenomena::Planet::MERCURY, false)};
  ::printf("Mercury Elongation Value: %f\n", MercuryWesternElongationValue);
  double MarsStation2{CAAPlanetaryPhenomena::True(-2, CAAPlanetaryPhenomena::Planet::MARS, CAAPlanetaryPhenomena::Type::STATION2)};
  ...
  ::printf("Mercury K: %f\n", MercuryK);
  double MercuryIC{CAAPlanetaryPhenomena::True(MercuryK, CAAPlanetaryPhenomena::Planet::MERCURY, CAAPlanetaryPhenomena::Type::INFERIOR_CONJUNCTION)};
  ::printf("Mercury True Inferior Conjunction: %f\n", MercuryIC);
  ...
  ::printf("Venus K: %f\n", VenusKpp);
  double VenusIC{CAAPlanetaryPhenomena::True(VenusKpp, CAAPlanetaryPhenomena::Planet::VENUS, CAAPlanetaryPhenomena::Type::INFERIOR_CONJUNCTION)};
  ...
  ::printf("Mars K: %f\n", MarsKpp);
  double MarsOP{CAAPlanetaryPhenomena::True(MarsKpp, CAAPlanetaryPhenomena::Planet::MARS, CAAPlanetaryPhenomena::Type::OPPOSITION)};
  ...
  ::printf("Jupiter K: %f\n", JupiterKpp);
  double JupiterOP{CAAPlanetaryPhenomena::True(JupiterKpp, CAAPlanetaryPhenomena::Planet::JUPITER, CAAPlanetaryPhenomena::Type::OPPOSITION)};
  ...
  ::printf("Saturn K: %f\n", SaturnKpp);
  double SaturnOP{CAAPlanetaryPhenomena::True(SaturnKpp, CAAPlanetaryPhenomena::Planet::SATURN, CAAPlanetaryPhenomena::Type::OPPOSITION)};
  ...
  ::printf("Uranus K: %f\n", UranusKpp);
  double UranusOP{CAAPlanetaryPhenomena::True(UranusKpp, CAAPlanetaryPhenomena::Planet::URANUS, CAAPlanetaryPhenomena::Type::OPPOSITION)};
  ...
  ::printf("Neptune K: %f\n", NeptuneKpp);
  double NeptuneOP{CAAPlanetaryPhenomena::True(NeptuneKpp, CAAPlanetaryPhenomena::Planet::NEPTUNE, CAAPlanetaryPhenomena::Type::OPPOSITION)};
  ::printf("Neptune True Opposition: %f\n", NeptuneOP);

  //Test out the CAAPlanetaryPhenomena2 class
  ::printf("Planet Phenomena for Mercury\n");
  System::Collections::Generic::List<CAAPlanetaryPhenomenaDetails2>^ events7{CAAPlanetaryPhenomena2::Calculate(CAADynamicalTime::UTC2TT(2449292.5), CAADynamicalTime::UTC2TT(2449492.5), CAAPlanetaryPhenomena2::Object::MERCURY, 0.007, false)};
  for (auto& event : events7)
  {
    switch (event.type)
    {
  ...
  while (bContinue4)
  {
    auto saturnrings3{CAASaturnRings::Calculate(JDUT3)};
  ...
  */
  ...
  CAAEclipticalElementDetails ed5{CAAEclipticalElements::Calculate(131.5856, 242.6797, 138.6637, 2433282.4235, 2448188.5 + 0.6954-63.6954)};
