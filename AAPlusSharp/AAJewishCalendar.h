...
{
public ref class AAPLUS_EXT_CLASS CAAJewishCalendar
{
public:
//Static methods
  static CAACalendarDate DateOfPesach(long Year, bool bGregorianCalendar);
  static CAACalendarDate DateOfPesach(long Year) { return DateOfPesach(Year, true); }
