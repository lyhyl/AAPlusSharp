...
{
public ref class AAPLUS_EXT_CLASS CAAFK5
{
public:
//Static methods
  ...
  static CAA3DCoordinate ConvertVSOPToFK5J2000(CAA3DCoordinate% value);
  static CAA3DCoordinate ConvertVSOPToFK5B1950(CAA3DCoordinate% value);
  static CAA3DCoordinate ConvertVSOPToFK5AnyEquinox(CAA3DCoordinate% value, double JDEquinox);
};
