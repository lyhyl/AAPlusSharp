...
System::Collections::Generic::List<CAAMoonPerigeeApogeeDetails2>^ CAAMoonPerigeeApogee2::Calculate(double StartJD, double EndJD, double StepInterval, Algorithm algorithm)
{
  //What will be the return value
  System::Collections::Generic::List<CAAMoonPerigeeApogeeDetails2>^ events = gcnew System::Collections::Generic::List<CAAMoonPerigeeApogeeDetails2>(0);
