...
{
  VSOP87Coefficient* pCoefficients;
  size_t nCoefficientsSize;
};

public ref class AAPLUS_EXT_CLASS CAAVSOP87
{
public:
//Static methods
  static double Calculate(double JD, VSOP87Coefficient2* pTable, size_t nTableSize, bool bAngle);
  static double Calculate_Dash(double JD, VSOP87Coefficient2* pTable, size_t nTableSize);
};
