...
{
public value class AAPLUS_EXT_CLASS CAACalendarDate
{
public:
//Member variables
  long Year;
...
public ref class AAPLUS_EXT_CLASS CAADate
{
public:
//Enums
  enum class DOW
...
//Non Static methods
  [[nodiscard]] double Julian() { return m_dblJulian; };
  operator double() { return m_dblJulian; };
  [[nodiscard]] long Day();
  [[nodiscard]] long Month();
  [[nodiscard]] long Year();
  [[nodiscard]] long Hour();
  [[nodiscard]] long Minute();
  [[nodiscard]] double Second();
  ...
  [[nodiscard]] DOW DayOfWeek();
  [[nodiscard]] double DayOfYear();
  [[nodiscard]] long DaysInMonth();
  [[nodiscard]] long DaysInYear();
  [[nodiscard]] bool Leap();
  [[nodiscard]] bool InGregorianCalendar() { return m_bGregorianCalendar; };
  [[nodiscard]] double FractionalYear();
