...
CAA3DCoordinate CAAFK5::ConvertVSOPToFK5J2000(CAA3DCoordinate% value)
{
...
CAA3DCoordinate CAAFK5::ConvertVSOPToFK5B1950(CAA3DCoordinate% value)
{
  CAA3DCoordinate result;
...
CAA3DCoordinate CAAFK5::ConvertVSOPToFK5AnyEquinox(CAA3DCoordinate% value, double JDEquinox)
{
  double t{(JDEquinox - 2451545)/36525};
  double tsquared{t*t};
