...
{
public ref class AAPLUS_EXT_CLASS CAAElementsPlanetaryOrbit
{
public:
//Static methods
  static double MercuryMeanLongitude(double JD);

  static double MercurySemimajorAxis(double )
  {
    return 0.387098310;
  }
  ...
  static double VenusSemimajorAxis(double )
  {
    return 0.723329820;
  }
  ...
  static double EarthSemimajorAxis(double )
  {
    return 1.000001018;
  }
  ...
  static double EarthInclination(double )
  {
    return 0;
  }
  ...
  static double MarsSemimajorAxis(double )
  {
    return 1.523679342;
  }
