...
System::Collections::Generic::List<CAAMoonPhasesDetails2>^ CAAMoonPhases2::Calculate(double StartJD, double EndJD, double StepInterval, Algorithm algorithm)
{
  //What will be the return value
  System::Collections::Generic::List<CAAMoonPhasesDetails2>^ events = gcnew System::Collections::Generic::List<CAAMoonPhasesDetails2>(0);
