...
History: PJN / 26-11-2010 1. CAARefraction::RefractionFromApparent now returns aant refraction value for all 
                          altitudes below a certain limit. Thanks to mehrzad khoddam for prompting this update.
                          2. CAARefraction::RefractionFromTrue now returns aant refraction value for all 
                          altitudes below a certain limit. Thanks to mehrzad khoddam for prompting this update.
...
{
  //return aant value from this method if the altitude is below a specific value
