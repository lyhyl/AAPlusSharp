...
System::Collections::Generic::List<CAAPlanetaryPhenomenaDetails2>^ CAAPlanetaryPhenomena2::Calculate(double StartJD, double EndJD, Object object, double StepInterval, bool bHighPrecision)
{
  //What will be the return value
  System::Collections::Generic::List<CAAPlanetaryPhenomenaDetails2>^ events = gcnew System::Collections::Generic::List<CAAPlanetaryPhenomenaDetails2>(0);
  ...
  while (JD < EndJD)
  {
    CAAEllipticalPlanetaryDetails SunDetails{CAAElliptical::Calculate(JD, CAAElliptical::Object::SUN, bHighPrecision)};
    ...
    if ((LastConjunctionValueInEclipticLongitude0 != -1) && (LastConjunctionValueInEclipticLongitude1 != -1))
    {
      if ((LastConjunctionValueInEclipticLongitude0 > ConjunctionValueInEclipticLongitude) && (LastConjunctionValueInEclipticLongitude0 > LastConjunctionValueInEclipticLongitude1))
      {
        ...
        double fraction{0};
        double Extremum{CAAInterpolate::Extremum(LastConjunctionValueInEclipticLongitude1, LastConjunctionValueInEclipticLongitude0, ConjunctionValueInEclipticLongitude, fraction)};
        if ((object == Object::MERCURY) || (object == Object::VENUS))
    ...
    if ((LastConjunctionValueInRA0 != -1) && (LastConjunctionValueInRA1 != -1))
    {
      if ((LastConjunctionValueInRA0 > ConjunctionValueInRA) && (LastConjunctionValueInRA0 > LastConjunctionValueInRA1))
      {
        ...
        double fraction{0};
        double Extremum{CAAInterpolate::Extremum(LastConjunctionValueInRA1, LastConjunctionValueInRA0, ConjunctionValueInRA, fraction)};
        if ((object == Object::MERCURY) || (object == Object::VENUS))
          event.Value = Extremum;
        else
          event.Value = 12;
    ...
    double ElongationValue{CAAAngularSeparation::Separation(SunDetails.ApparentGeocentricRA, SunDetails.ApparentGeocentricDeclination, ObjectDetails.ApparentGeocentricRA, ObjectDetails.ApparentGeocentricDeclination)};
    ...
    if (LastConjunctionValueInRA0 != -1)
    {
      if (((LastConjunctionValueInRA0 < 6) && (ConjunctionValueInRA >= 6)) || ((LastConjunctionValueInRA0 > 6) && (ConjunctionValueInRA <= 6)))
      {
        ...
        double fraction{(6 - LastConjunctionValueInRA0)/(ConjunctionValueInRA - LastConjunctionValueInRA0)};
        event.JD = LastJD + (fraction*StepInterval);
        event.Value = 6;
        events->Add(event);
      }
    ...
    if (LastConjunctionValueInEclipticLongitude0 != -1)
    {
      if (((LastConjunctionValueInEclipticLongitude0 < 90) && (ConjunctionValueInEclipticLongitude >= 90)) || ((LastConjunctionValueInEclipticLongitude0 > 90) && (ConjunctionValueInEclipticLongitude <= 90)))
      {
        ...
        double fraction{(90 - LastConjunctionValueInEclipticLongitude0)/(ConjunctionValueInEclipticLongitude - LastConjunctionValueInEclipticLongitude0)};
        event.JD = LastJD + (fraction*StepInterval);
        event.Value = 90;
        events->Add(event);
      }
    ...
    if (LastElongationValue0 != -1)
    {
      if (((LastElongationValue0 < 90) && (ElongationValue >= 90)) || ((LastElongationValue0 > 90) && (ElongationValue <= 90)))
      {
        ...
        double fraction{(90 - LastElongationValue0)/(ElongationValue - LastElongationValue0)};
        event.JD = LastJD + (fraction*StepInterval);
        event.Value = 90;
        events->Add(event);
      }
    }
    double StationValueInEclipticLongitude{ObjectDetails.ApparentGeocentricEclipticalLongitude};
    ...
    double StationValueInRA{ObjectDetails.ApparentGeocentricRA};
    ...
    double MinDistance{ObjectDetails.TrueGeocentricDistance};
...
void CAAPlanetaryPhenomena2::CorrectRAValuesForInterpolation(double% Alpha1, double% Alpha2, double% Alpha3)
{
...
void CAAPlanetaryPhenomena2::CorrectLongitudeValuesForInterpolation(double% Long1, double% Long2, double% Long3)
{
