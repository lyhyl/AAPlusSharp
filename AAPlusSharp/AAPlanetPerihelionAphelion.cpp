...
double CAAPlanetPerihelionAphelion::EarthPerihelion(double k, bool bBarycentric)
{
  double ksquared{k*k};
...
double CAAPlanetPerihelionAphelion::EarthAphelion(double k, bool bBarycentric)
{
  double ksquared{k*k};
  double JD{2451547.507 + (365.2596358*k) + (0.0000000156*ksquared)};
