...
std::array<MoonPerigeeApogeeCoefficient, 60> g_MoonPerigeeApogeeCoefficients1
{ {
  { 2,  0,  0,  -1.6769,  0        },
  { 4,  0,  0,  0.4589,   0        },
  { 6,  0,  0,  -0.1856,  0        },
...
std::array<MoonPerigeeApogeeCoefficient, 32> g_MoonPerigeeApogeeCoefficients2
{ {
  { 2,  0,  0,  0.4392,   0        },
  { 4,  0,  0,  0.0684,   0        },
...
std::array<MoonPerigeeApogeeCoefficient, 46> g_MoonPerigeeApogeeCoefficients3
{ {
  { 2,  0,  0,   63.224,   0        },
  { 4,  0,  0,   -6.990,   0        },
  { 2,  -1, 0,   2.834,    -0.0071  },
...
std::array<MoonPerigeeApogeeCoefficient, 17> g_MoonPerigeeApogeeCoefficients4
{ {
  { 2,  0,  0,  -9.147,     0      },
  { 1,  0,  0,  -0.841,     0      },
  { 0,  0,  2,  0.697,      0      },
...
double CAAMoonPerigeeApogee::TruePerigee(double k)
{
  ...
  double Sigma{0};
  for (auto& coeff : g_MoonPerigeeApogeeCoefficients1)
...
double CAAMoonPerigeeApogee::PerigeeParallax(double k)
{
  ...
  for (auto& coeff : g_MoonPerigeeApogeeCoefficients3)
...
double CAAMoonPerigeeApogee::TrueApogee(double k)
{
  ...
  double Sigma{0};
  for (auto& coeff : g_MoonPerigeeApogeeCoefficients2)
    Sigma += (coeff.C + (T*coeff.T))*sin((D*coeff.D) + (M*coeff.M) + (F*coeff.F));
...
double CAAMoonPerigeeApogee::ApogeeParallax(double k)
{
  ...
  for (auto& coeff : g_MoonPerigeeApogeeCoefficients4)
    Parallax += (coeff.C + (T*coeff.T))*cos((D*coeff.D) + ((M*coeff.M) + (F*coeff.F)));
