...
std::array<VSOP87Coefficient, 90> g_L0SaturnCoefficients
{ {
  { 87401354, 0,          0            },
...
std::array<VSOP87Coefficient, 79> g_L1SaturnCoefficients
{ {
  { 21354295596.0, 0,         0           },
...
std::array<VSOP87Coefficient, 63> g_L2SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 48> g_L3SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 27> g_L4SaturnCoefficients
{ {
  { 1662, 3.9983, 7.1135  },
  { 257,  2.984,  220.413 },
  { 236,  3.902,  14.227  },
...
std::array<VSOP87Coefficient, 12> g_L5SaturnCoefficients
{ {
  { 124, 2.259, 7.114  },
  { 34,  2.16,  14.23  },
  { 28,  1.20,  220.41 },
...
std::array<VSOP87Coefficient, 34> g_B0SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 32> g_B1SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 29> g_B2SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 21> g_B3SaturnCoefficients
{ {
  { 666, 1.990, 213.299 },
  { 632, 5.698, 206.186 },
  { 398, 0,     0       },
...
std::array<VSOP87Coefficient, 12> g_B4SaturnCoefficients
{ {
  { 80, 1.12, 206.19 },
  { 32, 3.12, 213.30 },
  { 17, 2.48, 220.41 },
...
std::array<VSOP87Coefficient, 2> g_B5SaturnCoefficients
{ {
  { 8, 2.82, 206.19 },
  { 1, 0.51, 220.41 }
} };

std::array<VSOP87Coefficient, 44> g_R0SaturnCoefficients
{ {
  { 955758136, 0,          0            },
...
std::array<VSOP87Coefficient, 38> g_R1SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 32> g_R2SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 28> g_R3SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 23> g_R4SaturnCoefficients
{ {
...
std::array<VSOP87Coefficient, 18> g_R5SaturnCoefficients
{ {
  { 129, 5.913, 220.413 },
  { 32,  0.69,  7.11    },
  { 27,  5.91,  227.53  },
