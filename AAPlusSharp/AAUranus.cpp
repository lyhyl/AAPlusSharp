...
std::array<VSOP87Coefficient, 91> g_L0UranusCoefficients
{ {
  { 548129294, 0,         0          },
...
std::array<VSOP87Coefficient, 57> g_L1UranusCoefficients
{ {
  { 7502543122.0, 0,        0         },
...
std::array<VSOP87Coefficient, 35> g_L2UranusCoefficients
{ {
  { 53033, 0,      0       },
  { 2358,  2.2601, 74.7816 },
  { 769,   4.526,  11.046  },
...
std::array<VSOP87Coefficient, 18> g_L3UranusCoefficients
{ {
  { 121, 0.024, 74.782 },
  { 68,  4.12,  3.93   },
  { 53,  2.39,  11.05  },
...
std::array<VSOP87Coefficient, 4> g_L4UranusCoefficients
{ {
  { 114, 3.142, 0     },
  { 6,   4.58,  74.78 },
  { 3,   0.35,  11.05 },
...
std::array<VSOP87Coefficient, 28> g_B0UranusCoefficients
{ {
...
std::array<VSOP87Coefficient, 20> g_B1UranusCoefficients
{ {
...
std::array<VSOP87Coefficient, 11> g_B2UranusCoefficients
{ {
  { 9212, 5.8004, 74.7816 },
  { 557,  0,      0       },
  { 286,  2.177,  149.563 },
...
std::array<VSOP87Coefficient, 4> g_B3UranusCoefficients
{ {
  { 268, 1.251, 74.782 },
  { 11,  3.14,  0      },
  { 6,   4.01,  149.56 },
...
std::array<VSOP87Coefficient, 1> g_B4UranusCoefficients
{ {
  { 6,  2.85, 74.78 }
} };

std::array<VSOP87Coefficient, 59> g_R0UranusCoefficients
{ {
  { 1921264848, 0,          0           },
...
std::array<VSOP87Coefficient, 35> g_R1UranusCoefficients
{ {
...
std::array<VSOP87Coefficient, 18> g_R2UranusCoefficients
{ {
...
std::array<VSOP87Coefficient, 10> g_R3UranusCoefficients
{ {
  { 1164, 4.7345, 74.7816 },
  { 212,  3.343,  63.736  },
  { 196,  2.980,  70.849  },
...
std::array<VSOP87Coefficient, 2> g_R4UranusCoefficients
{ {
  { 53, 3.01, 74.78 },
  { 10, 1.91, 56.62 }
} };
