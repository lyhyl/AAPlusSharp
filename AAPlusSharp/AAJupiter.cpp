...
std::array<VSOP87Coefficient, 64> g_L0JupiterCoefficients
{ {
  { 59954691, 0,          0           },
...
std::array<VSOP87Coefficient, 61> g_L1JupiterCoefficients
{ {
  { 52993480757.0, 0,          0          },
...
std::array<VSOP87Coefficient, 57> g_L2JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 39> g_L3JupiterCoefficients
{ {
  { 6502, 2.5986, 7.1135   },
...
std::array<VSOP87Coefficient, 19> g_L4JupiterCoefficients
{ {
  { 669,  0.853,  7.114   },
  { 114,  3.142,  0       },
  { 100,  0.743,  14.227  },
...
std::array<VSOP87Coefficient, 5> g_L5JupiterCoefficients
{ {
  { 50, 5.26, 7.11   },
  { 16, 5.25, 14.23  },
  { 4,  0.01, 536.80 },
...
std::array<VSOP87Coefficient, 26> g_B0JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 22> g_B1JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 14> g_B2JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 9> g_B3JupiterCoefficients
{ {
  { 252,  3.381,  529.691 },
  { 122,  2.733,  522.577 },
  { 49,   1.04,   536.80  },
...
std::array<VSOP87Coefficient, 6> g_B4JupiterCoefficients
{ {
  { 15, 4.53, 522.58  },
  { 5,  4.47, 529.69  },
  { 4,  5.44, 536.80  },
...
std::array<VSOP87Coefficient, 1> g_B5JupiterCoefficients
{ {
  { 1,  0.09, 522.58 }
} };

std::array<VSOP87Coefficient, 46> g_R0JupiterCoefficients
{ {
  { 520887429,  0,          0            },
...
std::array<VSOP87Coefficient, 43> g_R1JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 36> g_R2JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 28> g_R3JupiterCoefficients
{ {
...
std::array<VSOP87Coefficient, 15> g_R4JupiterCoefficients
{ {
  { 129,  0.084,  536.805 },
  { 113,  4.249,  529.691 },
  { 83,   3.30,   522.58  },
...
std::array<VSOP87Coefficient, 7> g_R5JupiterCoefficients
{ {
  { 11, 4.75, 536.80  },
  { 4,  5.92, 522.58  },
  { 2,  5.57, 515.46  },
