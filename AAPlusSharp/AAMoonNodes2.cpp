...
System::Collections::Generic::List<CAAMoonNodesDetails2>^ CAAMoonNodes2::Calculate(double StartJD, double EndJD, double StepInterval, Algorithm algorithm)
{
  //What will be the return value
  System::Collections::Generic::List<CAAMoonNodesDetails2>^ events = gcnew System::Collections::Generic::List<CAAMoonNodesDetails2>(0);
