...
double CAAInterpolate::Extremum(double Y1, double Y2, double Y3, double Y4, double Y5, double% nm, double epsilon)
{
  double A{Y2 - Y1};
  double B{Y3 - Y2};
  double C{Y4 - Y3};
...
double CAAInterpolate::Zero(double Y1, double Y2, double Y3, double epsilon)
{
  double a{Y2 - Y1};
  double b{Y3 - Y2};
  double c{Y1 + Y3 - (2*Y2)};
...
double CAAInterpolate::Zero(double Y1, double Y2, double Y3, double Y4, double Y5, double epsilon)
{
  double A{Y2 - Y1};
  double B{Y3 - Y2};
  double C{Y4 - Y3};
...
double CAAInterpolate::Zero2(double Y1, double Y2, double Y3, double epsilon)
{
  double a{Y2 - Y1};
  double b{Y3 - Y2};
  double c{Y1 + Y3 - (2*Y2)};
...
double CAAInterpolate::Zero2(double Y1, double Y2, double Y3, double Y4, double Y5, double epsilon)
{
  double A{Y2 - Y1};
  double B{Y3 - Y2};
  double C{Y4 - Y3};
