...
#endif //#ifdef _MSC_VER
double CAAVSOP87::Calculate(double JD, VSOP87Coefficient2* pTable, size_t nTableSize, bool bAngle)
{
...
#pragma warning(suppress : 26429)
#endif //#ifdef _MSC_VER
double CAAVSOP87::Calculate_Dash(double JD, VSOP87Coefficient2* pTable, size_t nTableSize)
{
//Validate our parameters
  assert(pTable);
