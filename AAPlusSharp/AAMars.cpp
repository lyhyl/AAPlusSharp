...
std::array<VSOP87Coefficient, 69> g_L0MarsCoefficients
{ {
  { 620347712,  0,          0             },
...
std::array<VSOP87Coefficient, 46> g_L1MarsCoefficients
{ {
  { 334085627474.0, 0,          0            },
...
std::array<VSOP87Coefficient, 33> g_L2MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 12> g_L3MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 8> g_L4MarsCoefficients
{ {
  { 114,  3.1416, 0        },
  { 29,   5.64,   6681.22  },
  { 24,   5.14,   3340.61  },
...
std::array<VSOP87Coefficient, 2> g_L5MarsCoefficients
{ {
  { 1,  3.14, 0       },
  { 1,  4.04, 6681.22 }
} };

std::array<VSOP87Coefficient, 16> g_B0MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 9> g_B1MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 7> g_B2MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 4> g_B3MarsCoefficients
{ {
  { 607,  1.981,  3340.612 },
  { 43,   0,      0        },
  { 14,   1.80,   6681.22  },
...
std::array<VSOP87Coefficient, 3> g_B4MarsCoefficients
{ {
  { 13, 0,    0       },
  { 11, 3.46, 3340.61 },
  { 1,  0.50, 6681.22 }
...
std::array<VSOP87Coefficient, 45> g_R0MarsCoefficients
{ {
  { 153033488,  0,          0             },
...
std::array<VSOP87Coefficient, 27> g_R1MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 11> g_R2MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 6> g_R3MarsCoefficients
{ {
...
std::array<VSOP87Coefficient, 4> g_R4MarsCoefficients
{ {
  { 20, 3.58, 3340.61  },
  { 16, 4.05, 6681.22  },
  { 6,  4.46, 10021.84 },
