...
{
public ref class AAPLUS_EXT_CLASS CAACoordinateTransformation
{
public:
...
//Inlined functions
  ...
  static double DMSToDegrees(double Degrees, double Minutes, double Seconds, bool bPositive);
  static double DMSToDegrees(double Degrees, double Minutes, double Seconds) { return DMSToDegrees(Degrees, Minutes, Seconds, true); }
