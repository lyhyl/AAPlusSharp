...
{
public value class AAPLUS_EXT_CLASS CAAMoonMaxDeclinationsDetails2
{
public:
//Enums
  enum class Type
...
public ref class AAPLUS_EXT_CLASS CAAMoonMaxDeclinations2
{
public:
//Enums
...
//Static methods
  static System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>^ Calculate(double StartJD, double EndJD, double StepInterval, Algorithm algorithm);
  static System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>^ Calculate(double StartJD, double EndJD) { return Calculate(StartJD, EndJD, 0.007, Algorithm::MeeusTruncated); }
  static System::Collections::Generic::List<CAAMoonMaxDeclinationsDetails2>^ Calculate(double StartJD, double EndJD, double StepInterval) { return Calculate(StartJD, EndJD, StepInterval, Algorithm::MeeusTruncated); }
