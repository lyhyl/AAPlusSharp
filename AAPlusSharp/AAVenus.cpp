...
History: PJN / 18-03-2012 1. All global "g_*" tables are now. Thanks to Roger Dahl for reporting this 
...
std::array<VSOP87Coefficient, 24> g_L0VenusCoefficients
{ {
  { 317614667, 0,         0             },
...
std::array<VSOP87Coefficient, 12> g_L1VenusCoefficients
{ {
  { 1021352943053.0, 0,       0           },
...
std::array<VSOP87Coefficient, 8> g_L2VenusCoefficients
{ {
  { 54127, 0,      0          },
...
std::array<VSOP87Coefficient, 3> g_L3VenusCoefficients
{ {
  { 136, 4.804, 10213.286 },
  { 78,  3.67,  20426.57  },
  { 26,  0,     0         }
...
std::array<VSOP87Coefficient, 3> g_L4VenusCoefficients
{ {
  { 114, 3.1416, 0        },
  { 3,   5.21,   20426.57 },
  { 2,   2.51,   10213.29 }
...
std::array<VSOP87Coefficient, 1> g_L5VenusCoefficients
{ {
  { 1, 3.14, 0 }
} };

std::array<VSOP87Coefficient, 9> g_B0VenusCoefficients
{ {
...
std::array<VSOP87Coefficient, 4> g_B1VenusCoefficients
{ {
...
std::array<VSOP87Coefficient, 4> g_B2VenusCoefficients
{ {
...
std::array<VSOP87Coefficient, 4> g_B3VenusCoefficients
{ {
  { 647, 4.992, 10213.286 },
  { 20,  3.14,  0         },
  { 6,   0.77,  20426.57  },
...
std::array<VSOP87Coefficient, 1> g_B4VenusCoefficients
{ {
  { 14, 0.32, 10213.29 }
} };

std::array<VSOP87Coefficient, 12> g_R0VenusCoefficients
{ {
  { 72334821, 0,        0            },
...
std::array<VSOP87Coefficient, 3> g_R1VenusCoefficients
{ {
...
std::array<VSOP87Coefficient, 3> g_R2VenusCoefficients
{ {
...
std::array<VSOP87Coefficient, 1> g_R3VenusCoefficients
{ {
  { 50, 3.22, 10213.29 }
} };

std::array<VSOP87Coefficient, 1> g_R4VenusCoefficients
{ {
  { 1, 0.92, 10213.29 }
} };
