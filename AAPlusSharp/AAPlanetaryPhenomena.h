...
{
public ref class AAPLUS_EXT_CLASS CAAPlanetaryPhenomena
{
public:
//Enums
  enum class Planet
...
//Static methods
  static double K(double Year, Planet planet, Type type);
  static double Mean(double k, Planet planet, Type type);
  static double True(double k, Planet planet, Type type);
  static double ElongationValue(double k, Planet planet, bool bEastern);
};
