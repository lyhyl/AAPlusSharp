...
CAANodeObjectDetails CAANodes::PassageThroAscendingNode(CAAEllipticalObjectElements% elements)
{
...
CAANodeObjectDetails CAANodes::PassageThroDescendingNode(CAAEllipticalObjectElements% elements)
{
...
CAANodeObjectDetails CAANodes::PassageThroAscendingNode(CAAParabolicObjectElements% elements)
{
  double v{CAACoordinateTransformation::MapTo0To360Range(-elements.w)};
  v = CAACoordinateTransformation::DegreesToRadians(v);
  double s{tan(v/2)};
...
CAANodeObjectDetails CAANodes::PassageThroDescendingNode(CAAParabolicObjectElements% elements)
{
  double v{CAACoordinateTransformation::MapTo0To360Range(180 - elements.w)};
  v = CAACoordinateTransformation::DegreesToRadians(v);
  double s{tan(v/2)};
