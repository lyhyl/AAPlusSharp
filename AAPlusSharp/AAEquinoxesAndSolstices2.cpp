...
System::Collections::Generic::List<CAAEquinoxSolsticeDetails2>^ CAAEquinoxesAndSolstices2::Calculate(double StartJD, double EndJD, double StepInterval, bool bHighPrecision)
{
  //What will be the return value
  System::Collections::Generic::List<CAAEquinoxSolsticeDetails2>^ events = gcnew System::Collections::Generic::List<CAAEquinoxSolsticeDetails2>(0);
  ...
  while (JD < EndJD)
  {
    double lambda{CAASun::ApparentEclipticLongitude(JD, bHighPrecision)};
    double beta{CAASun::ApparentEclipticLatitude(JD, bHighPrecision)};
